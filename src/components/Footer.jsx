    ...
    return (
        ...
        <footer className="footerbg">
            ...
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                ...
                <div>
                <img src="https://flowbite.com/docs/images/logo.svg" className="mr-5 h-6 sm:h-9" alt="logo" />
                    <p className="max-w-xs mt-4 text-sm text-gray-400 font-semibold">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, accusantium.
                    </p>
                    <div className="flex mt-8 space-x-6 text-gray-400 font-semibold mx-auto justify-left">
...
">
                    ...
                    <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-400 font-semibold">
